...
namespace Doss.Model_Place_Categories
{
    class Place_Categories
    {
    ...
    {
        public static PlaceCategories FromJson(string json) => JsonConvert.DeserializeObject<PlaceCategories>(json, Model_Place_Categories.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this PlaceCategories self) => JsonConvert.SerializeObject(self, Model_Place_Categories.Converter.Settings);
    }
